...
@NamedQueries({
        ...
        @NamedQuery(name = "getLessonsByTime", query = "select l from Lesson l " +
                "where l.lessonDescription.studentGroup = :studentGroup " +
                "and l.lessonDescription.semester = :semester " +
                "and l.dayOfWeek = :dayOfWeek and l.lessonNumber = :lessonNumber"),
